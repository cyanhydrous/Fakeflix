...
class MainActivity : AppCompatActivity() {
    ...
    var adaptador: AdaptadorPelicula? = null
    ...
    fun cargarPeliculas(){
        ...
        peliculas.add(Pelicula("Big Hero 6",R.drawable.bighero6, R.drawable.bighero6, "When a devastating event befalls the city of San Fransokyo and catapults Hiro into the midst of danger, he turns to Baymax and his close friends adrenaline junkie Go Go Tomago, neatnik Wasabi, chemistry whiz Honey Lemon and fanboy Fred. Determined to uncover the mystery, Hiro transforms his friends into a band of high-tech heroes called ‘Big Hero 6.’"))
    ...
    class AdaptadorPelicula:BaseAdapter{
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            var vista = inflater.inflate(R.layout.pelicula_view, null)

            vista.tv_pelicula.setImageResource(pelicula.image)
            vista.tv_titulo.setText(pelicula.titulo)

            vista.tv_pelicula.setOnClickListener{
                ...
                Toast.makeText(this.contexto,"Main Activity",Toast.LENGTH_SHORT).show()
            }
